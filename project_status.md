...
- 优化了用户体验:
  - 在ResetPasswordForm组件中添加了加载状态指示器
  - 在密码重置请求发送时显示加载动画
  - 禁用提交按钮以防止重复提交
- 创建了LoadingSpinner组件用于显示加载动画
- 实现了全局Toast通知系统:
  - 创建了Toast组件用于显示通知
...
## 下一步建议
1. 在其他组件中继续集成了Toast通知:
   - 更新了LoginForm组件,使用Toast通知替代原有的错误和成功消息显示
   - 更新了RegisterForm组件,使用Toast通知替代原有的错误和成功消息显示
   - 优化了用户体验,提供了更一致的反馈机制
   - 在登录和注册表单中添加了加载状态指示器
